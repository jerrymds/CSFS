...
{
    public class AgentTransactionRecordsDetailController : AppController
    {
        TransactionRecordsBIZ biz = new TransactionRecordsBIZ();
        // GET: Common/AgentTransactionRecordsDetail
        public ActionResult Index(CaseDataLog TransRecords, string FromControl)
        {
