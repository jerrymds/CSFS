...
{
    public class AgentSendSettingInfoDetailController : AppController
    {
        ...
        public ActionResult _SendCreate(Guid caseId)
        {
            ...
            IList<CaseSendSettingQueryResultViewModel> listRtn = cssBIZ.GetSendSettingList(caseId);
            CaseSendSettingCreateViewModel css = new CaseSendSettingCreateViewModel { CaseId = caseId };
            ...
            {
                css.ReceiveList = new List<CaseSendSettingDetails>();
                css.CcList = new List<CaseSendSettingDetails>();
        ...
        [HttpPost]
        public ActionResult _SendCreate(CaseSendSettingCreateViewModel model)
        {
        ...
        public ActionResult _SendDelete(int serialId)
        {
            ...
            return Content(cssBIZ.Delete(serialId, userId) > 0 ? "true" : "false");
        }
