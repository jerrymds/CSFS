...
(function () {
    ...
    var $ = jQuery;
    var WarningReturn = $.WarningReturn = {};
    jQuery.extend(WarningReturn, {
        documentReady: function () {
            //* init
            if ($("#NowPage").val() === "WarningReturn") {
                $.WarningReturn.initWarningReturn();
            }
        },

        //* 進入後初始化查詢畫面
        initWarningReturn: function () {
            $("#btnQuery").click(function () { return $.WarningReturn.QueryData(); });
