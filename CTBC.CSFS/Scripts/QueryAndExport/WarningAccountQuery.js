...
(function () {
    ...
    var $ = jQuery;
    var warningAccountQuery = $.WarningAccountQuery = {};
    jQuery.extend(warningAccountQuery, {
        documentReady: function () {
            //* init
            if ($("#NowPage").val() === "WarningAccountQuery") {
                $.WarningAccountQuery.initWarningAccountQuery();
            }
        },

        //* 進入後初始化查詢畫面
        initWarningAccountQuery: function () {
            $("#btnQuery").click(function () { return $.WarningAccountQuery.QueryData(); });
    ...
    jQuery(document).ready(function () {
        $.WarningAccountQuery.documentReady();
    });
})(jQuery);
