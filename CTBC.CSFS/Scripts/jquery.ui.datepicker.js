...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		yearRange: '1911:2099', // Range of years to display in drop-down,
...
$.extend(Datepicker.prototype, {
	...
	_updateAlternate: function(inst) {
		...
		if (altField) { // update alternate field too
			...
			$(altField).each(function() { var pickDateId = $("#"+$(inst).attr('id')).attr('pickId');var pickid = $(this).attr("id");if (pickDateId == pickid) {$("#" + pickid).val(dateStr);$("#" + pickid).change();} });
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		var formatYear=function(v){return (v-1911)+'年';};
