                ...
                using (SqlConnection conn = new SqlConnection(connStr))
                {
                    ...
                    using (SqlCommand comm = conn.CreateCommand())
                    {
                        ...
                        comm.CommandText = @"declare @LogID int
                                            ...
                                            exec sp_NUMSLogWriteLog 1,2,'Critical','Schedule',@nowDateTime,'NA','NA','NA','NA','NA','NA',@Message,'ScheduleService|S|I|S|CTCB.NUMS.ScheduleService|NA|NA|" + GetHostIPAddress() + @"|" + bSvrName + @"|',@LogID output
                                            exec sp_NUMSLogToCategory 4,@LogID";
