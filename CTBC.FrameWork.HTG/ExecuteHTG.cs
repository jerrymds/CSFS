    ...
    public class ExecuteHTG
    {
        ...
        public string HTGMainFun(string HTGNo, string ObligorID, string CustomID, string CaseID, string Acc_No = null, Hashtable htparm=null)
        {
            ...
            try
            {
                ...
                Thread.Sleep(sleepms); //20220630 ... 
                int threadid = Thread.CurrentThread.ManagedThreadId;
                string strId = threadid.ToString().PadLeft(3, '0').Substring(0, 3);
                ...
                string strSno = "C" + strYear.Substring(1, 2) + strMonth + strDay + strHour + strId;
                string ccy="TWD";
                ...
                switch (HTGNo)
                {
                    case "60491":
                        ...
                        break;
                    case "60491N":
                        return P4_60491U(ObligorID, CaseID, strSno,"N");
                        break;
                    case "67072":
                    ...
                    case "00450":
                        ...
                        break;
                    case "20450":
                        return P4_20450U(CaseID, htparm, strSno);
                        break;
                    case "20480":
                        return P4_20480U(CaseID, htparm, strSno);
                        break;
                    case "67050":
                        return P4_67050U(ObligorID, CaseID, strSno);
                        break;
                    case "67101":
                        return P4_67101_U(ObligorID, CaseID, strSno);
                    case "67050_5":
                        return P4_67050_5U(ObligorID, CaseID, strSno);
                        break;
                    case "67050_8":
                    ...
                    case "09095":
                        ...
                        break;
                    case "09098":
                        return P4_9098U(ObligorID, CaseID, htparm, strSno);
                        break;
                    case "09099":
        ...
        /// <returns></returns>
        public string Send9091(string Account, string Ccy, string Code, string Memo, string ObligorNo, string caseid, string DTSRC_Date = null, string WRITTEN="N" )
        {
        ...
        public string Send9098(string Account, string Ccy, string Code, string Memo, string ObligorNo, string caseid, string DTSRC_Date, string DUE_DATE, string WRITTEN = "N")
        {


            //// 20220824, 要先打9091 .. FUNCTION=1 , 
            //string res9091 = "0000|";
            //Hashtable htparm1 = new Hashtable();
            ////ExecuteHTG objHTG = new ExecuteHTG();
            //// 先發9091
            //htparm1.Add("CURRENCY", Ccy);
            //htparm1.Add("STOP_RESN_CODE", Code);
            //htparm1.Add("ACCT_NO", Account);
            //htparm1.Add("DTSRC_DATE", DTSRC_Date);
            ////htparm1.Add("DUE_DATE", DUE_DATE);
            ////htparm1.Add("STOP_RESN_DESC", Memo);
            //htparm1.Add("WRITTEN", WRITTEN);
            //htparm1.Add("FUNCTION", "1");

            //if (sendHTG)
            //    res9091 = HTGMainFun("09091", ObligorNo, "", caseid, "", htparm: htparm1);
            //else
            //    res9091 = "0000|"; // 測試用.. 不用每次DEBUG都要發電文


            //if (!res9091.StartsWith("0000|"))
            //    return "0001|打9091 發生錯誤, 因此無法打9098";
            ...
            htparm.Add("ACCT_NO", Account);
            htparm.Add("DTSRC_DATE", DTSRC_Date);
            htparm.Add("DUE_DATE", DUE_DATE);
            htparm.Add("STOP_RESN_DESC", Memo);
            htparm.Add("WRITTEN", WRITTEN);
            htparm.Add("FUNCTION", "1");

            string ret = "0000|";
            if (sendHTG)
                ret = HTGMainFun("09098", ObligorNo, "", caseid, "", htparm: htparm);
            else
                ret = "0000|"; // 測試用.. 不用每次DEBUG都要發電文
        ...
        /// <returns></returns>
        public string Send417_OLD(string ObligorNo, string caseid, string Acc_No)
        {
            ExecuteHTG objHTG = new ExecuteHTG();
            // ----------------------------------------DEBUG用----------------------------
            ...
            if (ret.StartsWith("0000"))
            {
                
                {
                    ...
                    string sql = "SELECT TOP 1* FROM TX_00417 WHERE TRNNUM='{0}'  AND CASEID='{1}'  ";
        ...
        public string Send67102(string ObligorNo, Guid caseid, ref string RetMessage)
        {
            ...
            if (result.StartsWith("0000"))
            {
...

                {
                    ...
                    string sql = "SELECT TOP 1 * FROM TX_67102 WHERE TRNNUM='{0}'  AND CASEID='{1}'  ORDER BY SNO DESC";
                    string formsql = string.Format(sql, _trn, caseid.ToString());
        ...
        public List<ObligorAccount> Send60491_CaseDeath(string ObligorNo, Guid caseid, Dictionary<string, string> BranchInfo, ref string retMessage)
        {
            string ret = "0000|";


            ret = this.HTGMainFun("60491", ObligorNo, "", caseid.ToString());
        ...
        public List<string> Send60600(string ObligorNo, Guid caseid,  ref string retMessage)
        {
            ...
            if (ret.StartsWith("0000"))
            {
                ...
                string sql = "SELECT DATA FROM TX_60600 WHERE TRNNUM='{0}'  AND CASEID='{1}'  AND FIELD_NAME='中文姓名' ";
                string formsql = string.Format(sql, _trn, caseid.ToString());
        ...
        public Dictionary<string, string> getAccident2(string ObligorNo, string caseid, string Acc_No, string Ccy, ref string retMessage)
        {
            ...
            if (sendResult.StartsWith("0000|"))
            {
                ...
                string sql1 = "SELECT * FROM TX_00450 WHERE TRNNUM='{0}'  AND ACCOUNT = '{1}'  AND CASEID='{2}'  AND (DATA1 LIKE '% 9091 %' OR DATA1 LIKE '% 9092 %' OR DATA1 LIKE '% 9098 %' ) ORDER BY SNO ";
                string formsql1 = string.Format(sql1, _trn, Acc_No, caseid.ToString());
        ...
        public bool getAccident(string ObligorNo, string caseid, string Acc_No, string Ccy, ref string message450, ref string message450Code,  ref string retMessage)
        {
            ...
            if (sendResult.StartsWith("0000|"))
            {
                ...
                string sql1 = "SELECT * FROM TX_00450 WHERE TRNNUM='{0}'  AND ACCOUNT = '{1}' AND ( DATA2 LIKE '%{2}%'  OR DATA2 LIKE '%{3}%'  OR DATA2 LIKE '%{4}%'  OR DATA2 LIKE '%{5}%'  OR DATA2 LIKE '%{6}%'  OR DATA2 LIKE '%{7}%' OR DATA2 LIKE '%{8}%' OR DATA2 LIKE '%{9}%' OR DATA2 LIKE '%{10}%' OR DATA2 LIKE '%{11}%' )  AND CASEID='{12}' ";
                string formsql1 = string.Format(sql1, _trn, Acc_No, " 04 ", " 05 ", " 06 ", " 07 ", " 08 ", " 10 ", " 11 ", " 12 ", " 13 ", " 14 ", caseid.ToString());
                DataTable gCase1 = hostbiz.getDataTabe(formsql1);
                if (gCase1 == null) // 若都沒有這些, 直接回
                    return false;
        ...
        public string Send20450(string Acc_No, string caseid, string sDate, string eDate)
        {
            ExecuteHTG objHTG = new ExecuteHTG();

            Hashtable htparm1 = new Hashtable();
            htparm1.Add("ACCT_NO", Acc_No);
            htparm1.Add("FIELD_05", "1");
            htparm1.Add("START_DATE", sDate);
            htparm1.Add("END_DATE", eDate);
            htparm1.Add("TXN_TYPE", "00");
            htparm1.Add("TELLER", "");
            htparm1.Add("FIELD_07", "");
            htparm1.Add("DATE_TYPE", "2");

            // ----------------------------------------DEBUG用----------------------------
            //  要帶頁數.. <data id="LIST_TX_FR_NO" value="1" /> , 直到看到<data id="DATA" value="END OF TXN"/>
            string ret = "0000|";
            if (sendHTG)
                ret = objHTG.HTGMainFun("20450", "", "", caseid, htparm: htparm1);
            else
                ret = "0000|"; // 測試用.. 不用每次DEBUG都要發電文
            // ----------------------------------------DEBUG用----------------------------
        ...
        public string Send20480(string Acc_No, string caseid, string respCode, string sDate, string eDate)
        {
            ExecuteHTG objHTG = new ExecuteHTG();

            Hashtable htparm1 = new Hashtable();
            htparm1.Add("ACCT_NO", Acc_No);
            htparm1.Add("REF_CODE", respCode);
            htparm1.Add("OPTION", "9");
            htparm1.Add("FROM_DATE", sDate);
            htparm1.Add("TO_DATE", eDate);
            htparm1.Add("ACTION", "");
            htparm1.Add("CONN_INST_NO", "");
            htparm1.Add("CONN_ACCT_NO", "");
            htparm1.Add("CONN_REF_CODE", "");
            htparm1.Add("CONN_DATE_TIME", "");

            // ----------------------------------------DEBUG用----------------------------
            //  要帶頁數.. <data id="LIST_TX_FR_NO" value="1" /> , 直到看到<data id="DATA" value="END OF TXN"/>
            string ret = "0000|";
            if (sendHTG)
                ret = objHTG.HTGMainFun("20480", "", "", caseid, htparm: htparm1);
            else
                ret = "0000|"; // 測試用.. 不用每次DEBUG都要發電文
            // ----------------------------------------DEBUG用----------------------------
        ...
        public string Send67101(string ObligorNo, string caseid)
        {
            ...
            string ret = "0000|";
            if (sendHTG)
                ret = HTGMainFun("67101", ObligorNo, "", caseid, htparm: htparm1);
            else
                ret = "0000|"; 
        ...
        private string P4_9093U(string ObligorID, string CaseID, Hashtable htparm, string strSno)
        {
            ...
            else // 與主機交易執行結果成功,取回交易結果的資料集, 註: Result = true並不代表一定有資料傳,因為可能在所傳入的查詢條件下並無符合的資料,但交易是成功的
            {
                ...
                if (!isSuccess)
                {
                 ...
                 // 20181114, 拿出RAMOUNT_OC57,  更新TX_33401, 同一帳戶, 的最後一筆TrueAmt 
                //{
                //    P4_UpdateTX_33401_TrueAmt(returnDS.Tables["TX_09093"]);
                //}
        ...
        /// <summary>
        /// 20181126, 決定, 直接去讀TX_9093的. 不要主動更新
        /// </summary>
        /// <param name="dataTable"></param>
        /// <returns></returns>
        private bool P4_UpdateTX_33401_TrueAmt_OLD(DataTable dataTable)
        {
            HostMsgGrpBIZ hostbiz = new HostMsgGrpBIZ();
            ArrayList array = new ArrayList();
           
            string sqlFormat = "UPDATE [dbo].[TX_33401]  SET [TrueAmt]='{0}' WHERE SNO = (SELECT MAX(SNO) FROM TX_33401 WHERE ACCT='{1}');";
            //UPDATE TX_33401 SET TrueAmt = 5000.00 WHERE SNO = (SELECT MAX(SNO) FROM TX_33401 WHERE ACCT='00000495540473948')
            ...
            foreach (DataRow dr in  dataTable.Rows)
            {
                ...
                decimal _trueamt = GetDecimal(dr["RAMOUNT_OC57"].ToString()) / 1000;
                string _acct = dr["Account"].ToString();

                string sqlStr  = string.Format(sqlFormat, _trueamt.ToString("F2"), _acct);
                array.Add(sqlStr);
        ...
        private string P4_9098U(string ObligorID, string CaseID, Hashtable htparm, string strSno)
        {
            HTGObject obj = new HTGObject(HTGUrl, HTGApplication, userId, passWord, racfId, racfPassWord, branchNo);
            bool result = obj.QueryHtg("09098", htparm);

            if (!result) // 執行第2次
            {
                System.Threading.Thread.Sleep(300);
                result = obj.QueryHtg("09098", htparm);
            }
            ...
            if (!result) //此為程式發生Exception或電文發送回應錯誤
            {
                ...
                string MFMessage = obj.ReturnCode["HGExceptionMessage"].ToString();
                WriteLog(log);
                return "0001|電文09098 發查失敗" + strMessage;
            }
            else // 與主機交易執行結果成功,取回交易結果的資料集, 註: Result = true並不代表一定有資料傳,因為可能在所傳入的查詢條件下並無符合的資料,但交易是成功的
            {
                //執行過程的log  
                ...
                DataSet returnDS = obj.HtgDataSet;
                #region 開始儲存至DB
                var masterCount = returnDS.Tables["TX_09098"].Rows.Count;
                bool isSuccess = P4_SinglePage_SaveToDB(returnDS, CaseID, ObligorID, "09098", strSno);
                if (!isSuccess)
                {
                    WriteLog(log);
                    return "0002|儲存09098失敗";
                }
                #endregion
                //return code
                Hashtable returnHT = obj.ReturnCode;
        ...
        /// <summary>
        /// 打67101, 需先打67050_5 , 先取得結果, 再修改
        /// <data id="GNDR" value="1"/>
        /// <data id="MRTL_STA" value="1"/>
        /// <data id="DEAD_FLAG" value="Y"/>
        /// </summary>
        /// <param name="ObligorID"></param>
        /// <param name="CaseID"></param>
        /// <param name="strSno"></param>
        /// <returns></returns>
        private string P4_67101_U(string ObligorID, string CaseID, String StrSno)
        {
            HTGObject obj = new HTGObject(HTGUrl, HTGApplication, userId, passWord, racfId, racfPassWord, branchNo);
            Hashtable htparm = new Hashtable();
            htparm.Add("CUST_ID_NO", ObligorID);
            var result = obj.QueryHtg("67101", htparm);
            ...
            if (!result) //此為程式發生Exception或電文發送回應錯誤
            {
                ...
                string MFMessage = obj.ReturnCode["HGExceptionMessage"].ToString();
                WriteLog(log);
                return "0001|電文67101 發查失敗 " + MFMessage;
            }
            else // 與主機交易執行結果成功,取回交易結果的資料集, 註: Result = true並不代表一定有資料傳,因為可能在所傳入的查詢條件下並無符合的資料,但交易是成功的
            {
                //執行過程的log  
                ...
                #region 開始儲存至DB
                // 要把Account也存回TABLE中
                var masterCount = returnDS.Tables["TX_67101"].Rows.Count;
                //foreach (DataRow dr in returnDS.Tables["TX_67101"].Rows)
                //{
                //    dr["Account"] = htparm["ACCT_NO"].ToString();
                //}
                bool isSuccess = P4_SinglePage_SaveToDB(returnDS, CaseID, ObligorID, "67101", StrSno);
                if (!isSuccess)
                {
                    WriteLog(log);
                    return "0002|儲存67101失敗";
                }
                #endregion
                //return code
                Hashtable returnHT = obj.ReturnCode;
        ...
        private string P4_67050_5U(string ObligorID, string CaseID, string strSno)
        {
            HTGObject obj = new HTGObject(HTGUrl, HTGApplication, userId, passWord, racfId, racfPassWord, branchNo);

            Hashtable htparm = new Hashtable();
            htparm.Add("CUST_ID_NO", ObligorID);
            bool result = obj.QueryHtg("670505", htparm);

            if (!result) // 執行第2次
            {
                System.Threading.Thread.Sleep(300);
                result = obj.QueryHtg("670505", htparm);
            }
        ...
        private string P4_00401U(string ObligorID, string CaseID, string Acc_No,string ccy, string strSno)
        {
            ...
            if (!result) //此為程式發生Exception或電文發送回應錯誤
            {
                ...
                string MFMessage = obj.ReturnCode["HGExceptionMessage"].ToString();
                WriteLog(log);
                return "0001|電文00401 發查失敗" + strMessage;
            }
            else // 與主機交易執行結果成功,取回交易結果的資料集, 註: Result = true並不代表一定有資料傳,因為可能在所傳入的查詢條件下並無符合的資料,但交易是成功的
            {
                //執行過程的log  
        ...
        private string P4_00450U(string ObligorID, string CaseID, Hashtable htparm, string strSno)
        {
            ...
            else // 與主機交易執行結果成功,取回交易結果的資料集, 註: Result = true並不代表一定有資料傳,因為可能在所傳入的查詢條件下並無符合的資料,但交易是成功的
            {
                ...
                string ccy = htparm["CURRENCY"].ToString();
                DataSet returnDS = obj.HtgDataSet;
                #region 開始儲存至DB
                var masterCount = returnDS.Tables["TX_00450"].Rows.Count;
                string wxoption = htparm["TX_TYPE"].ToString();
                bool isSuccess = P4_00450_SaveToDB(returnDS, CaseID, ObligorID, wxoption, Acc_No, strSno, ccy);
                if (!isSuccess)
                {
                    WriteLog(log);
        ...
        private string P4_20450U(string CaseID, Hashtable htparm, string strSno)
        {
            HTGObject obj = new HTGObject(HTGUrl, HTGApplication, userId, passWord, racfId, racfPassWord, branchNo);



            bool result = obj.QueryHtg("20450", htparm);

            if (!result) // 執行第2次
            {
                System.Threading.Thread.Sleep(300);
                result = obj.QueryHtg("20450", htparm);
            }
            ...
            else // 與主機交易執行結果成功,取回交易結果的資料集, 註: Result = true並不代表一定有資料傳,因為可能在所傳入的查詢條件下並無符合的資料,但交易是成功的
            {
                ...
                DataSet returnDS = obj.HtgDataSet;
                #region 開始儲存至DB
                var masterCount = returnDS.Tables["TX_20450"].Rows.Count;                
                bool isSuccess = P4_20450_SaveToDB(returnDS, CaseID,  Acc_No, strSno);
                if (!isSuccess)
                {
                    WriteLog(log);
                    return "0002|儲存20450DB失敗";
                }
                #endregion
                Hashtable returnHT = obj.ReturnCode;
            }
        ...
        private string P4_20480U(string CaseID, Hashtable htparm, string strSno)
        {
            HTGObject obj = new HTGObject(HTGUrl, HTGApplication, userId, passWord, racfId, racfPassWord, branchNo);



            bool result = obj.QueryHtg("20480", htparm);

            if (!result) // 執行第2次
            {
                System.Threading.Thread.Sleep(300);
                result = obj.QueryHtg("20480", htparm);
            }
            ...
            if (!result) //此為程式發生Exception或電文發送回應錯誤
            {
                ...
                string MFMessage = obj.ReturnCode["HGExceptionMessage"].ToString();
                WriteLog(log);
                return "0001|電文00480 發查失敗" + strMessage;
            }
            else // 與主機交易執行結果成功,取回交易結果的資料集, 註: Result = true並不代表一定有資料傳,因為可能在所傳入的查詢條件下並無符合的資料,但交易是成功的
            {
                //執行過程的log  
                ...
                DataSet returnDS = obj.HtgDataSet;
                #region 開始儲存至DB               
                var masterCount = returnDS.Tables["TX_20480"].Rows.Count;
                bool isSuccess = P4_20480_SaveToDB(returnDS, CaseID, Acc_No, strSno);
                if (!isSuccess)
                {
                    WriteLog(log);
                    return "0002|儲存20480DB失敗";
                }
                #endregion
                Hashtable returnHT = obj.ReturnCode;
            }
        ...
        private string P4_60491U(string obligorID, string caseID, string strSno,string Option="S")
        {
            ...
            if (Option == "N") // 20201228, 改為, 由是'N', 則日期為今天減1年
            {
                string newCloseDate = DateTime.Now.Day.ToString("00") + DateTime.Now.Month.ToString("00") + (DateTime.Now.Year-1).ToString("0000");
                htparm.Add("CLOSED_DATE", newCloseDate);
            }
            else
                htparm.Add("CLOSED_DATE", "05102016");
            htparm.Add("applicationId", "CSFS");
            htparm.Add("ENQUIRY_OPTION", Option);
            htparm.Add("CUST_ID_NO", obligorID);
        ...
        private bool P4_00450_SaveToDB(DataSet htgdata, string CaseID, string ObligorID,string WXOption, string account, string strSno, string CCY=null)
        {
...

            {
...

                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            string strSql = "insert into " + strTableName + " (";
                            strSql += "[cCretDT],caseId,[WXOption],[Account],TrnNum,RepMessage,";
                            //DataTable dtNew = dic[key];
                            for (int i = 0; i < dt.Columns.Count; i++)
                            {
                                strSql += "[" + dt.Columns[i].ColumnName + "],";
                            ...
                            strSql = strSql.TrimEnd(',') + ") values(";
                            strSql += "GETDATE(),'" + CaseID + "','" + WXOption + "','" + account + "','" + strSno + "','" + CCY + "',";
                            for (int i = 0; i < dt.Columns.Count; i++)
                            {
                                string strColumnName = dt.Columns[i].ColumnName;
                                strSql += "'" + dr[strColumnName].ToString() + "',";
        ...
        private bool P4_20450_SaveToDB(DataSet htgdata, string CaseID, string account, string strSno)
        {
            ...
            {
                DataTable dt = htgdata.Tables["TX_20450"];
                string strTableName = dt.TableName;

                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            string strSql = "insert into " + strTableName + " (";
                            strSql += "[cCretDT],caseId,[Account],TrnNum,RepMessage,";
                            //DataTable dtNew = dic[key];
                            for (int i = 0; i < dt.Columns.Count; i++)
                            {
                                strSql += "[" + dt.Columns[i].ColumnName + "],";
                            ...
                            strSql = strSql.TrimEnd(',') + ") values(";
                            strSql += "GETDATE(),'" + CaseID + "','" +  account + "','" + strSno + "','" + "" + "',";
                            for (int i = 0; i < dt.Columns.Count; i++)
                            {
                                string strColumnName = dt.Columns[i].ColumnName;
                                strSql += "'" + dr[strColumnName].ToString() + "',";
        ...
        private bool P4_20480_SaveToDB(DataSet htgdata, string CaseID, string account, string strSno)
        {
            ...
            {
                DataTable dt = htgdata.Tables["TX_20480"];
                string strTableName = dt.TableName;
        ...
        public void WriteLog(string msg)
        {
            ...
            msg ="Thread ID: " +  Thread.CurrentThread.ManagedThreadId.ToString() + "\t"  + msg;
            lock (_lockLog){
        ...
        public string Send67072(string ObligorNo, Guid caseid, ref string retMessage72)
        {
            ExecuteHTG objHTG = new ExecuteHTG();
            string ret = "0000|";
            ret = objHTG.HTGMainFun("67072", ObligorNo, "", caseid.ToString());   
            return ret;
        }
    }
}
