...
{
    public partial class Htg067100 : HtgXmlPara
    {
        #region 全域變數
        ...
        public override DataSet TransferXmlToDataSet(ArrayList recxmldatalist, out string strmessage)
        {
            ...
            DataTable dt067100Master = Createdt067100Master();
            ...
            try
            {
                ...
                for (int i = 0; i < recxmldatalist.Count; i++)
                {
                    ...
                    #region 若為第一頁則要insert dt067100Master
                    //if (linedata.Count == 2)  //表示第一頁
                    // (i == 0) // 表示第一頁
                    {
                        //寫入dt060491Master
                        DataRow _dr = dt067100Master.NewRow();
            ...
            finally
            {
                ...
                try
                {
                    ...
                    XmlData.Tables.Add(dt067100Master);
        ...
        private DataTable Createdt067100Master()
        {
            DataTable dt = new DataTable("TX_67100");
            
            dt.Columns.Add(new DataColumn("CustId"));
            dt.Columns.Add(new DataColumn("IdType"));
            dt.Columns.Add(new DataColumn("IdType01"));
            dt.Columns.Add(new DataColumn("IdDesc01"));
            dt.Columns.Add(new DataColumn("IdNo01"));
            dt.Columns.Add(new DataColumn("EffcDateDay01"));
            dt.Columns.Add(new DataColumn("ExpiDateDay01"));
            dt.Columns.Add(new DataColumn("IdValu01"));
            dt.Columns.Add(new DataColumn("Func01"));
            dt.Columns.Add(new DataColumn("Ind01"));
            dt.Columns.Add(new DataColumn("IdType02"));
            dt.Columns.Add(new DataColumn("IdDesc02"));
            dt.Columns.Add(new DataColumn("IdNo02"));
            dt.Columns.Add(new DataColumn("EffcDateDay02"));
            dt.Columns.Add(new DataColumn("ExpiDateDay02"));
            dt.Columns.Add(new DataColumn("IdValu02"));
            dt.Columns.Add(new DataColumn("Func02"));
            dt.Columns.Add(new DataColumn("Ind02"));
            dt.Columns.Add(new DataColumn("IdType03"));
            dt.Columns.Add(new DataColumn("IdDesc03"));
            dt.Columns.Add(new DataColumn("IdNo03"));
            dt.Columns.Add(new DataColumn("EffcDateDay03"));
            dt.Columns.Add(new DataColumn("ExpiDateDay03"));
            dt.Columns.Add(new DataColumn("IdValu03"));
            dt.Columns.Add(new DataColumn("Func03"));
            dt.Columns.Add(new DataColumn("Ind03"));
            dt.Columns.Add(new DataColumn("IdType04"));
            dt.Columns.Add(new DataColumn("IdDesc04"));
            dt.Columns.Add(new DataColumn("IdNo04"));
            dt.Columns.Add(new DataColumn("EffcDateDay04"));
            dt.Columns.Add(new DataColumn("ExpiDateDay04"));
            dt.Columns.Add(new DataColumn("IdValu04"));
            dt.Columns.Add(new DataColumn("Func04"));
            dt.Columns.Add(new DataColumn("Ind04"));
            dt.Columns.Add(new DataColumn("IdType05"));
            dt.Columns.Add(new DataColumn("IdDesc05"));
            dt.Columns.Add(new DataColumn("IdNo05"));
            dt.Columns.Add(new DataColumn("EffcDateDay05"));
            dt.Columns.Add(new DataColumn("ExpiDateDay05"));
            dt.Columns.Add(new DataColumn("IdValu05"));
            dt.Columns.Add(new DataColumn("Func05"));
            dt.Columns.Add(new DataColumn("Ind05"));
            dt.Columns.Add(new DataColumn("IdType06"));
            dt.Columns.Add(new DataColumn("IdDesc06"));
            dt.Columns.Add(new DataColumn("IdNo06"));
            dt.Columns.Add(new DataColumn("EffcDateDay06"));
            dt.Columns.Add(new DataColumn("ExpiDateDay06"));
            dt.Columns.Add(new DataColumn("IdValu06"));
            dt.Columns.Add(new DataColumn("Func06"));
            dt.Columns.Add(new DataColumn("Ind06"));
            dt.Columns.Add(new DataColumn("IdType07"));
            dt.Columns.Add(new DataColumn("IdDesc07"));
            dt.Columns.Add(new DataColumn("IdNo07"));
            dt.Columns.Add(new DataColumn("EffcDateDay07"));
            dt.Columns.Add(new DataColumn("ExpiDateDay07"));
            dt.Columns.Add(new DataColumn("IdValu07"));
            dt.Columns.Add(new DataColumn("Func07"));
            dt.Columns.Add(new DataColumn("Ind07"));
            dt.Columns.Add(new DataColumn("IdType08"));
            dt.Columns.Add(new DataColumn("IdDesc08"));
            dt.Columns.Add(new DataColumn("IdNo08"));
            dt.Columns.Add(new DataColumn("EffcDateDay08"));
            dt.Columns.Add(new DataColumn("ExpiDateDay08"));
            dt.Columns.Add(new DataColumn("IdValu08"));
            dt.Columns.Add(new DataColumn("Func08"));
            dt.Columns.Add(new DataColumn("Ind08"));
            dt.Columns.Add(new DataColumn("IdType09"));
            dt.Columns.Add(new DataColumn("IdDesc09"));
            dt.Columns.Add(new DataColumn("IdNo09"));
            dt.Columns.Add(new DataColumn("EffcDateDay09"));
            dt.Columns.Add(new DataColumn("ExpiDateDay09"));
            dt.Columns.Add(new DataColumn("IdValu09"));
            dt.Columns.Add(new DataColumn("Func09"));
            dt.Columns.Add(new DataColumn("Ind09"));
            dt.Columns.Add(new DataColumn("IdType10"));
            dt.Columns.Add(new DataColumn("IdDesc10"));
            dt.Columns.Add(new DataColumn("IdNo10"));
            dt.Columns.Add(new DataColumn("EffcDateDay10"));
            dt.Columns.Add(new DataColumn("ExpiDateDay10"));
            dt.Columns.Add(new DataColumn("IdValu10"));
            dt.Columns.Add(new DataColumn("Func10"));
            dt.Columns.Add(new DataColumn("Ind10"));
            dt.Columns.Add(new DataColumn("Pont"));
