...
{
    public partial class Htg09095 : HtgXmlPara
    {
        #region 全域變數
            ...
            string strxml = @"<?xml version=""1.0""?>
                                <hostgateway>
                                  <header>
                                    ...
                                    <data id=""transactionId"" value=""009095""/>
                                  ...
                                  <body>
                                    ...
                                    <data id=""ACCT_CUR_CODE"" value=""TWD"" />
        ...
        public override string GetPostTransactionXml(string recxml, Hashtable parmht)
        {
            ...
            datanode.Attributes["value"].Value = "009095";
        ...
        public override DataSet TransferXmlToDataSet(ArrayList recxmldatalist, out string strmessage)
        {
            ...
            DataTable dt09095 = Createdt09095();
        ...
        private DataTable Createdt09095()
        {
            DataTable dt = new DataTable("TX_09095");
