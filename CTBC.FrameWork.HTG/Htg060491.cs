            ...
            try
            {
                ...
                for (int i = 0; i < recxmldatalist.Count; i++)
                {
                    ...
                    for (int idx = 1; idx <= 6; idx++)
                    {
                        ...
                        //foreach (string sield in detailFiled2)
                        {
            ...
            finally
            {
                ...
                try
                {
                    ...
                    if (dt060491Detail.Rows.Count > 0)
                    {
                        ...
                        {
                            bool bfilter = true;
                            if (dr["Account"].ToString().Trim().StartsWith("000000000000"))
                                bfilter = false;
