...
{
    public partial class Htg09098 : HtgXmlPara
    {
        #region 全域變數
            ...
            string strxml = @"<?xml version=""1.0""?>
                                <hostgateway>
                                  <header>
                                    ...
                                    <data id=""transactionId"" value=""009098""/>
                                    <data id=""sessionId"" value=""#sessionId#""/>
                                    <data id=""lowValue"" value=""""/>
                                    <data id=""FLAG2"" value=""2"" />
                                    <data id=""FLAG1"" value=""2"" />
                                  </header>
                                  <body>
        ...
        public override string GetPostTransactionXml(string recxml, Hashtable parmht)
        {
            ...
            datanode.Attributes["value"].Value = "09098";
        ...
        public override DataSet TransferXmlToDataSet(ArrayList recxmldatalist, out string strmessage)
        {
            ...
            DataTable dt09098 = Createdt09098();
            ...
            Dictionary<string, string> masterMapping = new Dictionary<string, string>() { 
                {"Account","Account"},{"RESPONSE_OC08","RESPONSE_OC08"},{"CURRENCY_OC08","CURRENCY_OC08"},{"CMTRASH_OC08","CMTRASH_OC08"},{"DESCRIP_OC08","DESCRIP_OC08"},{"outputCode","outputCode"}
            };
        ...
        private DataTable Createdt09098()
        {
            DataTable dt = new DataTable("TX_09098");
