...
{
    public partial class Htg09092 : HtgXmlPara
    {
        #region 全域變數
            ...
            string strxml = @"<?xml version=""1.0""?>
                                <hostgateway>
                                  <header>
                                    ...
                                    <data id=""transactionId"" value=""009092""/>
                                  ...
                                  <body>
                                    ...
                                    <data value=""TWD"" id=""ACCT-CUR-CODE""/>
        ...
        public override string GetPostTransactionXml(string recxml, Hashtable parmht)
        {
            ...
            datanode.Attributes["value"].Value = "09092";
        ...
        public override DataSet TransferXmlToDataSet(ArrayList recxmldatalist, out string strmessage)
        {
            ...
            DataTable dt09091 = Createdt09092();
                ...
                for (int i = 0; i < recxmldatalist.Count; i++)
                {
                    ...
                    //if (i == 0) // 表示第一頁
                    {
                        ...
                        for (int line = 2; line <= linedata.Count; line++) // 因為有時會在LINE=3 , 有時在LINE=4.. 所以就全掃描
                        {
                            ...
                            //var hasElment = xmldoc.SelectSingleNode("/hostgateway/line[@no='" + line.ToString() + "']/msgBody/RESPONSE_OC08");
        ...
        private DataTable Createdt09092()
        {
            DataTable dt = new DataTable("TX_09092");
