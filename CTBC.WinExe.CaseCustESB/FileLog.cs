...
namespace CTBC.WinExe.CaseCustESB
{
    public class FileLog
    {
        ...
        // Methods
        public FileLog(string path, string name)
        {
            this.m_path = path;
            this.m_name = name;
        }
        ...
        private static string GetWorkType(WorkType workType)
        {
            switch (workType)
            {
                case WorkType.Work:
        ...
        public void Write(WorkType workType, ErrorType errorType, string message)
        {
            if ((this.m_path != "") && (this.m_name != ""))
            {
                ...
                try
                {
                    ...
                    string fileName = (this.m_path.EndsWith("\\") ? this.m_path : (this.m_path + @"\")) + this.m_name + "_" + time.ToString("dd") + ".log";
        ...
        public static void WriteLog(string message, ErrorType errorType, string fileName)
        {
